...
function discy_admin_options() {
	...
	$options = apply_filters("discy_options_after_general_setting",$options,$options_pages);
	...
	$options[] = array(
		'name' => esc_html__('The mobile apps bar enable or disable?','discy'),
		'desc' => esc_html__('Select ON to enable the mobile apps bar.','discy'),
		'id'   => 'mobile_bar_apps',
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name'    => esc_html__('Mobile apps bar skin','discy'),
		'desc'    => esc_html__('Choose the mobile apps bar skin.','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Type your iPhone app link','discy'),
		'id'   => 'mobile_bar_apps_iphone',
		'type' => 'text'
	);

	$options[] = array(
		'name' => esc_html__('Type your Android app link','discy'),
	...
	if (has_wpqa()) {
		...
		*/
		...
		$paymeny_setting = array(
			...
			"pay_to_sticky"     => esc_html__('Pay for sticky question','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Pay for sticky question','discy'),
			'id'   => 'pay_to_sticky',
			'type' => 'heading-2'
		);
		
		$options[] = array(
			'name' => esc_html__('Pay for sticky question at the top','discy'),
			'desc' => esc_html__('Select ON to active the pay for sticky question.','discy'),
			'id'   => 'pay_to_sticky',
			'type' => 'checkbox'
		);
		...
		$options[] = array(
			'name' => esc_html__("Number of points to be converted to money?","discy"),
	...
	$options[] = array(
		'name' => esc_html__('Block users for each other enable or disable.','discy'),
		'id'   => 'block_users',
		'std'  => 'on',
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name' => esc_html__('User blocking slug','discy'),
		'desc' => esc_html__('Put the user blocking slug.','discy'),
		'id'   => 'blocking_slug',
		'std'  => 'blocking',
		'type' => 'text'
	);
	...
	$options[] = array(
		'name' => esc_html__('Make the site for the logged users only?','discy'),
		'desc' => esc_html__('Select ON to activate the site for the logged users only.','discy'),
		'id'   => 'site_users_only',
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'type' => 'info',
		'name' => esc_html__('Unlogged page setting','discy')
	);
	...
	$options[] = array(
		'name'    => esc_html__('Upload the background','discy'),
		'desc'    => esc_html__('Upload the background for the unlogged page','discy'),
	...
	$options[] = array(
		'name'    => esc_html__("Choose from here which menu will show for unlogged users.","discy"),
		'id'      => 'register_menu',
		'type'    => 'select',
		'options' => $menus
	);
	...
	$options[] = array(
		'name'      => esc_html__("Choose if you want the posts or questions work for the unlogged users","discy"),
		'id'        => 'allow_post_types',
		'type'      => 'multicheck',
		'sort'      => 'yes',
	...
	$options[] = array(
		'name'    => esc_html__("Choose if you want the nickname and display name to be duplicate or not","discy"),
	...
	$options[] = array(
		...
		'type'    => 'multicheck',
		'sort'    => 'yes',
		'options' => apply_filters("discy_options_register_items",$register_items),
	...
	$options[] = array(
		...
		'options' => apply_filters("discy_options_edit_profile_items_1",$edit_profile_items_1),
	);
	...
	$options[] = array(
		'name' => esc_html__('Select ON to be able to view other questions.','discy'),
		'id'   => 'show_question',
		'std'  => "on",
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name' => esc_html__('Select ON to be able to view other answers.','discy'),
		'id'   => 'show_answer',
		'std'  => "on",
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name' => esc_html__('Select ON to be able to view other posts.','discy'),
		'id'   => 'show_post',
		'std'  => "on",
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name' => esc_html__('Select ON to be able to add a comment.','discy'),
		'id'   => 'add_comment',
		'std'  => "on",
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name' => esc_html__('Select ON to be able to view other comments.','discy'),
		'id'   => 'show_comment',
		'std'  => "on",
		'type' => 'checkbox'
	);
	...
	if (has_wpqa()) {
		...
		$options[] = array(
			'name' => esc_html__('Enable or disable the editor for details in group posts form','discy'),
			'id'   => 'editor_group_posts',
			'type' => 'checkbox'
		);

		$options[] = array(
			'name' => esc_html__('Featured image for the group posts','discy'),
			'type' => 'info'
		);
		
		$options[] = array(
			'name' => esc_html__('Enable or disable the featured image in group posts form','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Enable or disable the editor for the comments in the group posts','discy'),
			'id'   => 'editor_group_post_comments',
			'type' => 'checkbox'
		);

		$options[] = array(
			'name' => esc_html__('Featured image for the comments on the group posts','discy'),
			'type' => 'info'
		);
		
		$options[] = array(
			'name' => esc_html__('Enable or disable the featured image for the comments in the group posts','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Add a private answer','discy'),
		'desc' => esc_html__('Select ON to enable the private answer.','discy'),
		'id'   => 'private_answer',
		'type' => 'checkbox'
	);
	
	$options[] = array(
		'name'      => esc_html__('Activate the user who added the question to see private answer or not?','discy'),
		'desc'      => esc_html__('Select ON if you want active the user who added the question to see private answer.','discy'),
	...
	$options[] = array(
		'name'     => esc_html__('Notified reply on the answer title','discy'),
	...
	$options[] = array(
		'name'     => esc_html__('Notified reply on the answer template','discy'),
