jQuery(document).ready(function($) {
					...
					jQuery('#roles_list').append('<li id="li_roles_'+roles_j+'">\
						...
						<div class="widget-content">\
							<div class="widget-content-div">\
								...
								<div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_post]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_post]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_post]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_post]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_post]">'+discy_js.show_post+'</label></div></div></div>\
								<div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_comment]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_comment]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_comment]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_comment]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_comment]">'+discy_js.add_comment+'</label></div></div></div>\
								<div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_comment]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_comment]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_comment]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_comment]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_comment]">'+discy_js.show_comment+'</label></div></div></div>\
							</div>\
						</div>\
					</li>');
	...
	var update_form_elements = function(container,element = "") {
		...
		jQuery(".discy-form-elements").find(element+' .discy-form-select .discy-form-control,'+element+' .discy-form-select_category .discy-form-control,'+element+' .discy-form-radio .discy-form-control,'+element+' .discy-form-images .discy-form-control,'+element+' .discy-form-checkbox .discy-form-control').each(function() {
			var ct = jQuery(this);
			var checked = [];
			if (ct.attr('type') == "checkbox") {
				if (ct.prop('checked')) {
		...
		container.find('.discy-radio-img-img').each(function () {
			...
			radio_img.show().click(function() {
				...
				radio_img.parent().find(".discy-radio-img-radio").trigger("click").attr('checked','checked');
	...
	*/
		...
		if (!add_element.hasClass("not_add_element")) {
			...
			jQuery("#"+element_id+" .section,#"+element_id+" .wrap_class").each(function () {
				...
				if (!this_each.hasClass("wrap_class")) {
					if (data_add_to !== undefined && data_add_to !== false) {
						var last_id = discy_theme_var+"_"+data_add_to+"_"+add_element_j+"_"+this_attr;
					}else {
						var last_id = discy_theme_var+"_"+data_id+"_"+add_element_j+"_"+this_attr;
					}
				}
			...
			jQuery("#"+element_id+" .widget-content select").each(function () {
				...
				if (data_add_to !== undefined && data_add_to !== false) {
					var last_id   = discy_theme_var+"_"+data_add_to+"_"+add_element_j+"_"+this_attr;
					var last_name = discy_theme_var+data_add_to_name+"["+add_element_j+"]["+this_attr+"]";
				}else {
					var last_id   = discy_theme_var+"_"+data_id+"_"+add_element_j+"_"+this_attr;
					var last_name = discy_theme_var+data_id_name+"["+add_element_j+"]["+this_attr+"]";
				}
	...
	function discy_admin_tabs(meta = '') {
		...
		if (discy_tab_value != '' && jQuery(".discy_tabs a[href='"+discy_tab_value+"']").length) {
			...
			if (jQuery(".discy_tabs a[href='"+discy_tab_value+"']").parent().parent().parent().find(discy_tab_value).length) {
				...
				jQuery(discy_v).find(".discy_tabs > li:first-child a").addClass("discy_active").trigger("click");
	...
	if (jQuery(".discy_search").length) {
		...
		live_search.parent().on('click','a',function() {
			...
			jQuery(".discy_tabs").find("a[href='#"+thisparent.attr("id")+"']").trigger("click");
