			...
			if ($values != "") {
				...
				foreach ($array_options as $option) {
					if (isset($data[$option])) {
						...
						$data[$option]["facebook_app_id"] = $data[$option]["soundcloud_client_id"] = $data[$option]["behance_api_key"] = $data[$option]["google_api"] = $data[$option]["instagram_sessionid"] = $data[$option]["dribbble_client_id"] = $data[$option]["dribbble_client_secret"] = $data[$option]["dribbble_access_token"] = $data[$option]["twitter_consumer_key"] = $data[$option]["twitter_consumer_secret"] = $data[$option]["envato_token"] = "";
