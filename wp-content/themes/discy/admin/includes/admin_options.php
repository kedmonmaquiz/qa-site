	...
	function options_page() {
		...
		<div id="discy-admin-wrap" class="discy-admin">
			<?php if (!function_exists('mobile_options')) {?>
				<a class="app-img" href="https://2code.info/checkout/pay_for_apps/33664/" target="_blank"><img alt="Discy Mobile Application" src="https://2code.info/mobile/discount/960x100.png"></a>
