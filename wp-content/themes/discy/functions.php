...
if (is_admin() && (isset($_REQUEST['taxonomy']) && ($_REQUEST['taxonomy'] == "category" || $_REQUEST['taxonomy'] == "question-category")) && ($pagenow == "term.php" || $pagenow == "edit-tags.php" || (isset($_REQUEST["action"]) && $_REQUEST["action"] == "add-tag"))) {
...
function discy_maintenance_mode() {
	...
	if (!function_exists('wpqa_custom_queries') || (!is_super_admin() && isset($stop_id))) {
